      ...
      <div
        ...
        className={`pointer-events-auto relative transition-all duration-300 ease-in-out ${
          isCollapsed
            ...
            : 'w-80 sm:w-88 p-4 bg-white/95 backdrop-blur-md rounded-3xl shadow-xl border border-gray-100/90 flex flex-col gap-3.5 overflow-visible'
        }`}
      >
        {/* Toggle Button */}
        <button
          ...
          className={`transition-all flex items-center justify-center font-bold text-gray-600 bg-white hover:bg-gray-100 border border-gray-200/90 shadow-2xs cursor-pointer ${
            isCollapsed
              ...
              <>
                ...
                <div className="relative w-full flex flex-col gap-3 pt-0.5">
                  ...
                  <div className="relative flex items-center w-full bg-[#f0f0f2] hover:bg-[#eaeaea] focus-within:bg-white focus-within:ring-2 focus-within:ring-teal-500/30 focus-within:border-teal-500 border border-transparent rounded-full transition-all">
                    <SearchIcon className="w-4.5 h-4.5 text-gray-500 ml-4 flex-shrink-0" />
                    <input
                      type="text"
                    ...
                    {quickFilters.map((filter) => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-3 py-2.5 text-xs sm:text-[13px] font-medium rounded-2xl transition-all border cursor-pointer flex items-center gap-2.5 text-left w-full shadow-2xs ${
                            isActive
                              ? 'bg-teal-50 text-teal-900 border-teal-400 font-semibold shadow-xs'
